...
public class GyroscopeListener extends CordovaPlugin implements SensorEventListener {
    ...
    */
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (mGravity != null && mGeomagnetic != null) {
            ...
            if (success) {
                ...
                orientationData[0] = (float) Math.toDegrees(orientationData[0]);
                orientationData[1] = (float) Math.toDegrees(orientationData[1]);
                orientationData[2] = (float) Math.toDegrees(orientationData[2]);
    ...
    private JSONObject getOrientationJSON() {
        ...
        try {
            r.put("x", this.orientation[0]);
            r.put("y", this.orientation[1]);
            r.put("z", this.orientation[2]);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return r;
